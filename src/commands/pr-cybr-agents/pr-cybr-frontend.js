...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const repo = 'PR-CYBR/PR-CYBR-FRONTEND-AGENT';
        ...
        if (action === 'deploy') {
            try {
                ...
                await interaction.reply('Frontend deployment triggered successfully!');
            } catch (error) {
                console.error('Error triggering deployment:', error);
                await interaction.reply('Failed to trigger the frontend deployment.');
            }
